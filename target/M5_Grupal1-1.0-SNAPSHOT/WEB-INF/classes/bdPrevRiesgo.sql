drop database if exists prev_riesgo;
...
INSERT INTO clientes (username, password, nombre, fechaNacimiento, tipo, rutCliente, nombres, apellidos, telefono, afp, salud, direccion, comuna, edad)
VALUES ('admin', '1234', 'Ganon', '18/11/1994', 'Cliente', '189073526', 'Bastian Alberto', 'Mariangel Adrizola', 154687951, 'Modelo', 'Fonasa', 'Mars', 'Marispu', 28);
INSERT INTO clientes (username, password, nombre, fechaNacimiento, tipo, rutCliente, nombres, apellidos, telefono, afp, salud, direccion, comuna, edad)
VALUES ('chubaca', '1212', 'Chubita', '12/11/1953', 'Cliente', '16548974', 'Chewb', 'Baccina', 65489789, 'Capital', 'Isapre', 'Venus', 'Venuspris', 60);
INSERT INTO clientes (username, password, nombre, fechaNacimiento, tipo, rutCliente, nombres, apellidos, telefono, afp, salud, direccion, comuna, edad)
VALUES ('anything', '1313', 'Anyoki', '05/06/1800', 'Cliente', '132654787', 'Any', 'Thing', 654258769, 'Modelo', 'Fonasa', 'Pluton', 'Plutaster', 34);
...
INSERT INTO administrativos (username, password, nombre, fechaNacimiento, tipo, area, expPrevia)
VALUES ('Daniela', '117744', 'Daniela', '19/11/2000', 'Administrativo', 'Gerente', 'Administradora de grandes tiendas 3 años');
