...
<div class="container">
            ...
            <tr>
                ...
                <td>
                    <form method="post" action="svEliminarCliente">
                        ...
                        <button class="btn btn-sm btn-danger" type="button" onclick="confirmarEliminacionCliente('<%= cliente.getId()%>')">Eliminar</button>
                    </form>
                </td>
            </tr>
            </tbody>
    ...
    <div id="listaProfesionales" style="display: none">
        <table class="table table-dark">
            ...
            <tr>
                ...
                <td><%= profesional.getCreated_at()%></td>
                <td class="text-right">
                    <a href="editarProfesional.jsp?id=<%= profesional.getId() %>" class="btn btn-primary btn-sm">Editar</a>
                </td>
                <td>
                    <form method="post" action="svEliminarProfesional">
                        <input type="hidden" name="identificadorProfesional" value="<%= profesional.getId()%>">
                        <button class="btn btn-sm btn-danger" type="button" onclick="confirmarEliminacionProfesional('<%= profesional.getId()%>')">Eliminar</button>
                    </form>
                </td>
            </tr>
            </tbody>
    ...
    <div class="mb-3" style="display: flex; justify-content: space-between;">
        <button id="botonAdministrativos" class="btn btn-primary btn-dark mb-3 text-center">Mostrar Administrativos</button>
    </div>
    <div id="listaAdministrativos" style="display: none">
        <table class="table table-dark">
            ...
            <tr>
                ...
                <td><%= administrativo.getUsername()%></td>
                ...
                <td><%= administrativo.getCreated_at()%></td>
                <td class="text-right">
                ...
                <td>
                    <form method="post" action="svEliminarAdministrativo">
                        ...
                        <button class="btn btn-sm btn-danger" type="button" onclick="confirmarEliminacionAdministrativo('<%= administrativo.getId()%>')">Eliminar</button>
                    </form>
                </td>
            </tr>
            </tbody>
