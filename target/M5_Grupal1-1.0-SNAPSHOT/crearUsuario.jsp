...
<div class="container" >
  <div class="row justify-content-center">
    <div class="col-lg-4 col-md-6 col-sm-8">
      <form class="register-form" action="svCrearUsuario" method="POST" id="passwordForm" onsubmit="return validateForm()">
        <h2 class="text-center mb-4">Crear Usuario</h2>
        <div class="form-group">
          <label class="mb-3" for="Usuariox">Nombre de Usuario</label>
          <input name="nuevoUsuario" type="text" id="Usuariox" class="form-control" placeholder="Ingresa Usuario" minlength="4" required>
        </div>
        <br>
          <div class="form-group">
            <label class="mb-3" for="passwordy">Contraseña</label>
            <input name="nuevoPassword" type="password" id="passwordy" class="form-control" placeholder="Ingresa tu contraseña" minlength="6" required>
          </div>

          <div class="form-group">
            <label class="mb-3" for="confirmPassword">Confirmar contraseña</label>
            <input name="confirmarPassword" type="password" id="confirmPassword" class="form-control" placeholder="Confirma tu contraseña" required>
          </div>

        <div class="form-group">
          <label class="mb-3" for="nombre">Nombre</label>
          <input name="nombre" type="text" id="nombre" class="form-control" placeholder="Ingresa tu nombre"  minlength="3" required>
        </div>
        <div class="form-group">
          <label class="mb-3" for="fechaNacimiento">Fecha de Nacimiento</label>
          <input name="fechaNacimiento" type="text" id="fechaNacimiento" class="form-control" placeholder="Ingresa tu fecha de nacimiento " required>
        </div>
        <div class="form-group">
        ...
        <div id="camposCliente" style="display: none">
          ...
          <div class="form-group">
            <div class="form-group">
              ...
              <input name="rutCL" type="text" id="rutCL" class="form-control" placeholder="Ingresa el RUT de Cliente"  minlength="3"  >
            </div>
            <div class="form-group">
              <label class="mb-3" for="nombres">Nombres</label>
              <input name="nombres" type="text" id="nombres" class="form-control" placeholder="Ingresa tus nombres"  minlength="3" >
            </div>
            <div class="form-group">
              <label class="mb-3" for="apellidos">Apellidos</label>
              <input name="apellidos" type="text" id="apellidos" class="form-control" placeholder="Ingresa tus apellidos"  minlength="3"  >
            </div>
            <div class="form-group">
              <label class="mb-3" for="telefono">Telefono</label>
              <input name="telefono" type="number" id="telefono" class="form-control" placeholder="Ingresa tu telefono"  minlength="7" >
            </div>
            <div class="form-group">
              <label class="mb-3" for="afp">AFP</label>
              <input name="afp" type="text" id="afp" class="form-control" placeholder="Ingresa tu afp"  minlength="3" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input name="direccionCliente" type="text" id="direccionCliente" class="form-control" placeholder="Ingresa tu direccion"  minlength="3" >
            </div>
            <div class="form-group">
              <label class="mb-3" for="comuna">Comuna</label>
              <input name="comuna" type="text" id="comuna" class="form-control" placeholder="Ingresa tu comuna"  minlength="3" >
            </div>
            <div class="form-group">
              <label class="mb-3" for="edad">Edad</label>
              <input name="edad" type="number" id="edad" class="form-control" placeholder="Ingresa tu edad" >
            </div>
          </div>
        </div>
        ...
        <div id="camposProfesional" style="display: none">
          ...
          <div class="form-group">
            <div class="form-group">
              ...
              <input name="titulo" type="text" id="titulo" class="form-control" placeholder="Ingresa tu titulo profesional"  minlength="3">
            </div>
            <div class="form-group">
              <label class="mb-3" for="fechaIngreso">Fecha de Ingreso</label>
              <input name="fechaIngreso" type="text" id="fechaIngreso" class="form-control" placeholder="Ingresa tu fecha de ingreso"  minlength="3" >
            </div>
          </div>
        </div>
        ...
        <div id="camposAdministrativo" style="display: none">
          ...
          <div class="form-group">
            <div class="form-group">
              ...
              <input name="area" type="text" id="area" class="form-control" placeholder="Ingresa tu area"  minlength="3" >
            </div>
            <div class="form-group">
              <label class="mb-3" for="expPrevia">Experiencia</label>
              <input name="expPrevia" type="text" id="expPrevia" class="form-control" placeholder="Ingresa tu Experiencia Previa"  minlength="3" >
            </div>
          </div>
        </div>
