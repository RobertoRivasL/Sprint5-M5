      ...
      <div class="col-lg-4 col-md-6 col-sm-8">
        <form action="svEditarAdministrativo" method="post">
          <div class="form-group">
            ...
            <input name="nuevoID" type="text" id="nuevoID" class="form-control" placeholder="Ingresa Usuario" value="<%= administrativoEncontrado.getId() %>" minlength="4" required>
          </div>
          <div class="form-group">
            <label class="mb-3" for="Usuariox">Nombre de Usuario</label>
            <input name="nuevoUsuarioMOD" type="text" id="Usuariox" class="form-control" placeholder="Ingresa Usuario" value="<%= administrativoEncontrado.getUsername() %>" minlength="4" required>
          </div>
          <br>
          <div class="form-group">
            <label class="mb-3" for="passwordy">Contraseña</label>
            <input name="nuevoPasswordMOD" type="password" id="passwordy" class="form-control" placeholder="Ingresa tu contraseña" value="<%= administrativoEncontrado.getPassword() %>" minlength="6" required>
          </div>

          <div class="form-group">
            <label class="mb-3" for="nombre">Nombre</label>
            <input name="nombreMOD" type="text" id="nombre" class="form-control" placeholder="Ingresa tu nombre"  minlength="3" value="<%= administrativoEncontrado.getNombre() %>" required>
          </div>
          <div class="form-group">
            <label class="mb-3" for="fechaNacimiento">Fecha de Nacimiento</label>
            <input name="fechaNacimientoMOD" type="text" id="fechaNacimiento" class="form-control" placeholder="Ingresa tu fecha de nacimiento " value="<%= administrativoEncontrado.getFechaNacimiento() %>" required>
          </div>
          <div class="form-group">
          ...
          <div>
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <input name="areaMOD" type="text" id="areaMOD" class="form-control" placeholder="Ingresa Area" value="<%= administrativoEncontrado.getArea() %>"  minlength="3"  >
              </div>
              <div class="form-group">
                <label class="mb-3" for="expPreviaMOD">Experiencia Previa</label>
                <input name="expPreviaMOD" type="text" id="expPreviaMOD" class="form-control" placeholder="Ingresa Experiencia Previa" value="<%= administrativoEncontrado.getExpPrevia() %>" minlength="3" >
              </div>
