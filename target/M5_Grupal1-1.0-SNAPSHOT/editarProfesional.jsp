      ...
      <div class="col-lg-4 col-md-6 col-sm-8">
        <form action="svEditarProfesional" method="POST">
          <div class="form-group">
            ...
            <input name="nuevoID" type="text" id="nuevoID" class="form-control" placeholder="Ingresa Usuario" value="<%= profesionalEncontrado.getId() %>" minlength="4" required>
          </div>
          <div class="form-group">
            <label class="mb-3" for="Usuariox">Nombre de Usuario</label>
            <input name="nuevoUsuarioMOD" type="text" id="Usuariox" class="form-control" placeholder="Ingresa Usuario" value="<%= profesionalEncontrado.getUsername() %>" minlength="4" required>
          </div>
          <br>
          <div class="form-group">
            <label class="mb-3" for="passwordy">Contraseña</label>
            <input name="nuevoPasswordMOD" type="password" id="passwordy" class="form-control" placeholder="Ingresa tu contraseña" value="<%= profesionalEncontrado.getPassword() %>" minlength="6" required>
          </div>

          <div class="form-group">
            <label class="mb-3" for="nombre">Nombre</label>
            <input name="nombreMOD" type="text" id="nombre" class="form-control" placeholder="Ingresa tu nombre"  minlength="3" value="<%= profesionalEncontrado.getNombre() %>" required>
          </div>
          <div class="form-group">
            <label class="mb-3" for="fechaNacimiento">Fecha de Nacimiento</label>
            <input name="fechaNacimientoMOD" type="text" id="fechaNacimiento" class="form-control" placeholder="Ingresa tu fecha de nacimiento " value="<%= profesionalEncontrado.getFechaNacimiento() %>" required>
          </div>
          <div class="form-group">
          ...
          <div>
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <input name="tituloMOD" type="text" id="tituloMOD" class="form-control" placeholder="Ingresa titulo" value="<%= profesionalEncontrado.getTitulo() %>"  minlength="3"  >
              </div>
              <div class="form-group">
                <label class="mb-3" for="fechaIngresoMOD">Fecha Ingreso</label>
                <input name="fechaIngresoMOD" type="text" id="fechaIngresoMOD" class="form-control" placeholder="Ingresa fecha ingreso" value="<%= profesionalEncontrado.getFechaIngreso() %>" minlength="3" >
              </div>
